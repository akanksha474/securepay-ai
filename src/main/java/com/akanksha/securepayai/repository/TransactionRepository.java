...
public interface TransactionRepository extends JpaRepository<Transaction,Long>{
    ...
    List<Transaction> findByAccountAccountNumberAndTransactionTypeAndTransactionTimeAfter(String accountNumber, TransactionType transactionType, LocalDateTime time);
